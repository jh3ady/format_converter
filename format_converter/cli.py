...
@click.option(
    "--input-formatter", "-if", type=str, required=True, help="The input formatter."
)
@click.option(
    "--output", "-o", type=click.Path(), required=True, help="The output file."
)
@click.option(
    "--output-formatter", "-of", type=str, required=True, help="The output formatter."
)
@click.option(
    "--stdin",
    type=bool,
    ...
    required=False,
    default=False,
    help="The input should be read in the standard input",
)
@click.option(
    "--stdout",
    type=bool,
    ...
    required=False,
    default=False,
    help="The output should be write in the standard output",
)
def convert(
    input: os.PathLike,
    input_formatter: str,
